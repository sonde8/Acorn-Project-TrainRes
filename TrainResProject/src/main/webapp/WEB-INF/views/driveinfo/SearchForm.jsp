...
/* 그대로 유지 */
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .top-nav { background-color: #f8f8f8; border-bottom: 1px solid #ddd; padding: 0.5rem 0; }
    .top-nav-container {
        max-width: 1400px;
        margin: 0 auto;
        display: flex;
    ...
    .top-nav-right { display: flex; gap: 1rem; font-size: 0.9rem; }
    .nav-button {
        padding: 0.5rem 1rem;
    ...
    .main-content {
        ...
        height: 85vh;
        min-height: 500px;
        background: url('https://info.korail.com/DATA/bbs/1017/20250613095401946_ysNc.jpg');
    ...
    @media (max-width: 1200px) {
        ...
        .banner-section { width: 100%; max-width: 600px; }
        .search-section {
            width: 100%;
            max-width: 500px;
            margin-top: 2rem;
    ...
    <div class="content-wrapper">
        ...
        <div class="search-section">
            ...
            <form action="DriveInfoList" method="GET">
                ...
                <button type="submit" class="submit-btn">열차 조회하기</button>
            </form>
        </div>
    </div>
</div>
